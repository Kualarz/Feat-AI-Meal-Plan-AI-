  ...
  KH: [
    {
      ...
      cookwareJson: JSON.stringify(['Wok or large pan', 'Cutting board', 'Sharp knife', 'Spatula']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Large pot', 'Mortar and pestle', 'Saucepan', 'Strainer', 'Serving bowls']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Steamer', 'Mixing bowl', 'Whisk', 'Cutting board', 'Sharp knife']),
  ...
  TH: [
    {
      ...
      cookwareJson: JSON.stringify(['Wok', 'Spatula', 'Large bowl', 'Colander']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Large deep pan', 'Cutting board', 'Sharp knife', 'Wooden spoon']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Large pot', 'Ladle', 'Sharp knife', 'Serving bowls']),
  ...
  VN: [
    {
      ...
      cookwareJson: JSON.stringify(['Large stockpot', 'Skimmer', 'Fine mesh strainer', 'Serving bowls', 'Sharp knife']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Oven or toaster', 'Bread knife', 'Cutting board']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Large shallow bowl', 'Damp towel', 'Saucepan']),
  ...
  AU: [
    {
      ...
      cookwareJson: JSON.stringify(['Oven', 'Baking tray', 'Saucepan', 'Small pan', 'Zester']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Oven', 'Baking pan', 'Mixing bowls', 'Electric mixer', 'Wire rack', 'Double boiler']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Oven', 'Large mixing bowl', 'Electric mixer', 'Baking tray', 'Baking paper', 'Spatula']),
  ...
  US: [
    {
      ...
      cookwareJson: JSON.stringify(['Grill or skillet', 'Spatula', 'Cutting board', 'Knife']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Oven', 'Large pot', 'Saucepan', 'Whisk', 'Baking dish', 'Cheese grater']),
    ...
    },
    {
      ...
      cookwareJson: JSON.stringify(['Oven', 'Baking tray', 'Aluminum foil', 'Basting brush', 'Cast iron skillet', 'Mixing bowls']),
